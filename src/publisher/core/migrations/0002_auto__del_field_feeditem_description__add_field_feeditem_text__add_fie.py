...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FeedItem.description'
        db.delete_column('core_feeditem', 'description')

        # Adding field 'FeedItem.text'
        db.add_column('core_feeditem', 'text',
                      self.gf('django.db.models.fields.TextField')(default=datetime.datetime(2012, 12, 8, 0, 0)),
                      keep_default=False)

        # Adding field 'FeedItem.date_modified'
        db.add_column('core_feeditem', 'date_modified',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'FeedItem.description'
        raise RuntimeError("Cannot reverse this migration. 'FeedItem.description' and its values cannot be restored.")
        # Deleting field 'FeedItem.text'
        db.delete_column('core_feeditem', 'text')

        # Deleting field 'FeedItem.date_modified'
        db.delete_column('core_feeditem', 'date_modified')
